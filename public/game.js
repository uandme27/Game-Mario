...
canvas.style.backgroundImage = `url(./image/background/${map[randomIndex]})`
...
document.querySelector(".playButton").addEventListener('click', () => {
    ...
    key.src = './image/character/princes1.png';
    brickImage.src = './image/brick1.png';
    ...
    class Bricks {
        ...
        createBrick() {
            if (mon == 'quizM') {
                ...
                for (let i = 0; i < quiz.correctAnswer.length; i++) {
                    this.bricks.push({
                        x: i * ((canvas.width) / quiz.correctAnswer.length) / 3 + canvas.width / 3,
                        y: 650,
                        width: 140,
                        height: 100,
